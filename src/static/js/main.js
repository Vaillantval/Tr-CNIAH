...
// Newsletter form submission with AJAX (optional enhancement)
const newsletterForms = document.querySelectorAll('form[method="post"]');
newsletterForms.forEach(form => {
    // Check if it's a newsletter form by looking for email input
    ...
    if (emailInput && form.querySelector('button[type="submit"]')) {
        form.addEventListener('submit', function(e) {
            ...
            // For now, it will use standard form submission
        });
    }
});
